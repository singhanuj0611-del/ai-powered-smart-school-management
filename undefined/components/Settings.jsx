      ...
      <section style={wrapperStyle}>
        <div style={{ display: "grid", gap: "12px" }}>
          ...
          <span style={{ opacity: 0.6, fontSize: "13px" }}>
            Primary AI service. Get your key from platform.openai.com
          </span>
        </div>
        ...
        <div style={{ display: "grid", gap: "12px" }}>
          ...
          <input
            ...
            onChange={(event) => onChange({ geminiKey: event.target.value })}
            placeholder="AIza..."
            style={{
              borderRadius: "14px",
              padding: "14px",
          ...
          />
          <span style={{ opacity: 0.6, fontSize: "13px" }}>
            Fallback AI service. Used if OpenAI is unavailable. Get your key from makersuite.google.com/app/apikey
          </span>
        </div>
